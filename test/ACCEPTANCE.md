...
- `./scripts/docker-smoke.sh`：通過；包含測試與 production image build、image 敏感檔案檢查、瀏覽器 sandbox、唯讀 root filesystem、缺設定失敗、Compose up、restart 與 SIGTERM。
